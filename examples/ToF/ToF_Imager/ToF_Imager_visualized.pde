/*
  ...
  You can run this example with the Processing IDE: https://processing.org/
  ...
  change "/dev/ttyACM0" below to the name of your serial port. 
...
void setup(){
  ...
  port = new Serial(this, "/dev/ttyACM0", 9600); // CHANGE /dev/ttyACM0 TO YOUR SERIAL PORT
...
void draw(){
  ...
  for(int y=0; y<rows-1; y++){
    ...
    for(int x=0; x<cols; x++){
      fill(map(terrain[x][y],0,1000,255,0),255,255);
